 ...
 * @param {String} FQDN Fully Qualified domain name (If your using an IP Scheme needs to be HTTP)
 * @param {String} Scheme HTTP/HTTPS
 * @param {Boolean} BehindProxy Is this node behind a proxy? (true/false)
 * @param {String} RAM How much ram should the node have? 
 * @param {String} RAMOverAllocate How much overallocation for RAM? (Percent)
 * @param {String} Disk How much disk space should the node have?
 * @param {String} DiskOverallocate How much overallocation for the Disk? (percent)
 * @param {String} DaemonDir Directory of the daemon, normall /srv/daemon
 ...
 * @param {BigInteger} MaxUploadSize Mus be between 1 and 1024 or youll get 422
 */
